...
namespace UPM_IPS.JCJAPGDRCDERAWebBD
{
	...
	/// </summary>
	internal partial class JCJAPGDRCDERAWebBDCommandSet : JCJAPGDRCDERAWebBDCommandSetBase
	{
		/// <summary>
		/// Constructs a new JCJAPGDRCDERAWebBDCommandSet.
		/// </summary>
		public JCJAPGDRCDERAWebBDCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class JCJAPGDRCDERAWebBDCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new JCJAPGDRCDERAWebBDCommandSetBase.
		/// </summary>
		protected JCJAPGDRCDERAWebBDCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewJCJAPGDRCDERAWebBDExplorerCommand,
				typeof(JCJAPGDRCDERAWebBDEditorFactory).GUID);
		...
		{
			JCJAPGDRCDERAWebBDExplorerToolWindow explorer = this.JCJAPGDRCDERAWebBDExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentJCJAPGDRCDERAWebBDDocData != null && this.CurrentJCJAPGDRCDERAWebBDDocData.Store != null)
			{
				this.CurrentJCJAPGDRCDERAWebBDDocData.ValidationController.Validate(this.CurrentJCJAPGDRCDERAWebBDDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentJCJAPGDRCDERAWebBDDocData != null && this.CurrentJCJAPGDRCDERAWebBDDocData.Store != null)
			{
				...
				this.CurrentJCJAPGDRCDERAWebBDDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected JCJAPGDRCDERAWebBDDocData CurrentJCJAPGDRCDERAWebBDDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as JCJAPGDRCDERAWebBDDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected JCJAPGDRCDERAWebBDDocView CurrentJCJAPGDRCDERAWebBDDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as JCJAPGDRCDERAWebBDDocView;
			}
		}
		...
		/// </summary>
		protected JCJAPGDRCDERAWebBDExplorerToolWindow JCJAPGDRCDERAWebBDExplorerToolWindow
		{
			get
			{
				JCJAPGDRCDERAWebBDExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(JCJAPGDRCDERAWebBDExplorerToolWindow), true) as JCJAPGDRCDERAWebBDExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				JCJAPGDRCDERAWebBDExplorerToolWindow explorerWindow = this.JCJAPGDRCDERAWebBDExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class JCJAPGDRCDERAWebBDClipboardCommandSet : JCJAPGDRCDERAWebBDClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new JCJAPGDRCDERAWebBDClipboardCommandSet.
		/// </summary>
		public JCJAPGDRCDERAWebBDClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class JCJAPGDRCDERAWebBDClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new JCJAPGDRCDERAWebBDClipboardCommandSetBase.
		/// </summary>
		protected JCJAPGDRCDERAWebBDClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
