...
namespace UPM_IPS.JCJAPGDRCDERAWebBD
{
	...
	/// </summary>
	internal partial class JCJAPGDRCDERAWebBDDocView : JCJAPGDRCDERAWebBDDocViewBase
	{
		/// <summary>
		/// Constructs a new JCJAPGDRCDERAWebBDDocView.
		/// </summary>
		public JCJAPGDRCDERAWebBDDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class JCJAPGDRCDERAWebBDDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new JCJAPGDRCDERAWebBDDocView.
		/// </summary>
		protected JCJAPGDRCDERAWebBDDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			JCJAPGDRCDERAWebBDDocDataBase docData = this.DocData as JCJAPGDRCDERAWebBDDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for JCJAPGDRCDERAWebBDDocViewBase should be an JCJAPGDRCDERAWebBDDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::UPM_IPS.JCJAPGDRCDERAWebBD.JCJAPGDRCDERAWebBDDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::UPM_IPS.JCJAPGDRCDERAWebBD.JCJAPGDRCDERAWebBDDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::UPM_IPS.JCJAPGDRCDERAWebBD.JCJAPGDRCDERAWebBDToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::UPM_IPS.JCJAPGDRCDERAWebBD.JCJAPGDRCDERAWebBDToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.JCJAPGDRCDERAWebBDDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::UPM_IPS.JCJAPGDRCDERAWebBD.JCJAPGDRCDERAWebBDHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::UPM_IPS.JCJAPGDRCDERAWebBD.JCJAPGDRCDERAWebBDHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::UPM_IPS.JCJAPGDRCDERAWebBD.JCJAPGDRCDERAWebBDHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
