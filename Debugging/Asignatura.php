...
<body>
    ...
    <div class="formulario">
        <form action="Asignatura.php" method="POST">
            ...
            <div class="campo">
                <label for="AsignaturaId">
                    AsignaturaId <span class="pk-indicator">(*PK)</span>:
                </label>
                
                                    <input type="text" name="AsignaturaId" id="AsignaturaId" required>
                            </div>
    ...
    if(isset($_POST['enviar'])) {
        ...
        $sql = "INSERT INTO Asignatura VALUES (";
                     $val = isset($_POST['AsignaturaId']) ? $_POST['AsignaturaId'] : '';
