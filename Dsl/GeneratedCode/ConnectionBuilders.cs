...
namespace UPM_IPS.JCJAPGDRCDERAWebBD
{
	...
	/// ConnectionBuilder class to provide logic for constructing connections between elements.
	/// </summary>
	public static partial class DERAWebBDModelReferencesAtributoBuilder
	{
		#region Accept Connection Methods
		/// <summary>
		/// Test whether a given model element is acceptable to this ConnectionBuilder as the source of a connection.
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::UPM_IPS.JCJAPGDRCDERAWebBD.DERAWebBDModel)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::UPM_IPS.JCJAPGDRCDERAWebBD.DERAWebBDModel)
				{
					if (candidateTarget is global::UPM_IPS.JCJAPGDRCDERAWebBD.Atributo)
					{
						global::UPM_IPS.JCJAPGDRCDERAWebBD.DERAWebBDModel sourceDERAWebBDModel = (global::UPM_IPS.JCJAPGDRCDERAWebBD.DERAWebBDModel)candidateSource;
						global::UPM_IPS.JCJAPGDRCDERAWebBD.Atributo targetAtributo = (global::UPM_IPS.JCJAPGDRCDERAWebBD.Atributo)candidateTarget;
						if(targetAtributo == null || sourceDERAWebBDModel == null || global::UPM_IPS.JCJAPGDRCDERAWebBD.DERAWebBDModelReferencesAtributo.GetLinks(sourceDERAWebBDModel, targetAtributo).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				if (source is global::UPM_IPS.JCJAPGDRCDERAWebBD.DERAWebBDModel)
				{
					if (target is global::UPM_IPS.JCJAPGDRCDERAWebBD.Atributo)
					{
						global::UPM_IPS.JCJAPGDRCDERAWebBD.DERAWebBDModel sourceAccepted = (global::UPM_IPS.JCJAPGDRCDERAWebBD.DERAWebBDModel)source;
						global::UPM_IPS.JCJAPGDRCDERAWebBD.Atributo targetAccepted = (global::UPM_IPS.JCJAPGDRCDERAWebBD.Atributo)target;
						DslModeling::ElementLink result = new global::UPM_IPS.JCJAPGDRCDERAWebBD.DERAWebBDModelReferencesAtributo(sourceAccepted, targetAccepted);
						if (DslModeling::DomainClassInfo.HasNameProperty(result))
						{
							DslModeling::DomainClassInfo.SetUniqueName(result);
						}
	...
	/// Handles interaction between the ConnectionBuilder and the corresponding ConnectionTool.
	/// </summary>
	internal partial class EntidadAtributoConectarConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new EntidadAtributoConectarConnectAction for the given Diagram.
		/// </summary>
		public EntidadAtributoConectarConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the EntidadAtributoConectarConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			if(this.connectionTypes == null)
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new EntidadAtributoConectarConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class EntidadAtributoConectarConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the EntidadAtributoConectarConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected EntidadAtributoConectarConnectionTypeBase() : base() {}
		...
		private partial class EntidadAtributoConectarConnectionType : EntidadAtributoConectarConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the EntidadAtributoConectarConnectionType with the given ConnectionBuilder.
			/// </summary>
			public EntidadAtributoConectarConnectionType() : base() {}
		}
	}
}
