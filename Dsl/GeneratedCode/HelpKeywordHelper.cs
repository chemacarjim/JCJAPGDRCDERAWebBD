...
namespace UPM_IPS.JCJAPGDRCDERAWebBD
{
	...
	/// </remarks>
	public partial class JCJAPGDRCDERAWebBDHelpKeywordHelper : JCJAPGDRCDERAWebBDHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new JCJAPGDRCDERAWebBDHelpKeywordHelper.
		/// </summary>
		protected JCJAPGDRCDERAWebBDHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the JCJAPGDRCDERAWebBDHelpKeywordHelper.
		/// </summary>
		public static JCJAPGDRCDERAWebBDHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class JCJAPGDRCDERAWebBDHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new JCJAPGDRCDERAWebBDHelpKeywordHelperBase.
		/// </summary>
		protected JCJAPGDRCDERAWebBDHelpKeywordHelperBase()
			: base() { }
